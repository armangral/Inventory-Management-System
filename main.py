...
class Application:
    def __init__(self,master,*args,**kwargs):
        ...
        #components
        self.heading=Label(self.left,text="CUI STORE",font=('times 40 bold'),bg='white')
        ...
        self.date_l=Label(self.right,text="Today's Date: "+str(date),font=('times 16 bold'),bg='lightblue',fg='blue')
        self.date_l.place(x=0,y=0)

        #table invoice=======================================================
        self.tproduct=Label(self.right,text="Products",font=('arial 18 bold '),bg='lightblue',fg='red')
        self.tproduct.place(x=0,y=60)

        self.tquantity = Label(self.right, text="Quantity", font=('arial 18 bold'), bg='lightblue', fg='red')
        self.tquantity.place(x=300, y=60)

        self.tamount = Label(self.right, text="Amount", font=('arial 18 bold'), bg='lightblue', fg='red')
